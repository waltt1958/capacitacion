<%@ Page Title="" Language="VB" MasterPageFile="~/M.Master" AutoEventWireup="false" CodeFile="altaUsuario.aspx.vb" Inherits="altaUsuario" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h3>Alta de usuario al sistema</h3>
   ...
   <table style="width: 45%;" align="center" border="2" cellspacing="0" bordercolor="black">
        <tr>
            ...
            <td width="30%" align="center">
                <asp:TextBox ID="legajo" MaxLength="8" runat="server"></asp:TextBox>
         ...
         <tr>
            <td width="50%"><asp:Label ID="lblaYn" Font-Size="20" runat="server" Font-Bold="True" Text="Apellido y nombre"></asp:Label></td>
            <td width="30%" align="center">
                <asp:TextBox ID="aYnombre" MaxLength="50" runat="server"></asp:TextBox>
